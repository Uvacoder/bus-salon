  ...
  return (
    <div className="h-full px-0 mx-auto text-center sm:px-3 sm:px-6 max-w-7xl md:flex">
      ...
      <div className="p-5 sm:p-6 sm:rounded-b-lg md:p-8 font-branbold bg-pink md:order-1 md:text-left md:rounded-l-lg md:rounded-r-none md:w-bloc800 lg:w-bloc650">
        <h1 className="mb-4 text-4xl text-white xl:mt-4">Salon de coiffure de mixte à Lyon</h1>
        ...
        <a href="http://google.fr" className="flex items-center justify-center mb-4 text-xl text-white md:justify-start"><FiMapPin className="mb-2 mr-2"/> Voir sur la carte</a>
